...
public class Barometer {
    ...
    public void add_sample (float value, Environment environment)
    {
        ...
        switch (environment) {
            ...
            case NONE: {
                Log.e("Barometer", "Cannot register a value under: " + environment);
                return;
            }
        }
    }
    ...
    public void clear_samples (Barometer.Environment environment)
    {
        switch (environment) {
    ...
    public Environment getMatchingEnvironment (float sample)
    {
        ...
        if (samples_outside.size() == 0 || samples_inside.size() == 0) {
            return Environment.NONE;
        }

        average_stairs = (average_inside + average_outside)/2;
